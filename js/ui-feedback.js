...
export function renderTeamLogoHTML(teamName) {
    const slug = getTeamSlug(teamName);
    return `
            <picture>
                <source data-srcset="images/logos/${slug}.png" type="image/png">
                <img src="images/logos/${slug}.png" alt="${teamName}" class="team-logo">
            </picture>`;
}
