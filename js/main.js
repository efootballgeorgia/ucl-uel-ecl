...
function setupEventListeners() {
    ...
    // --- Match Card & Knockout Form Listeners (Event Delegation) ---
    ...
    dom.leagueTableBody.previousElementSibling.addEventListener(EVENTS.CLICK, (e) => {
        ...
        if (appState.sortBy === key) {
            ...
            appState.sortBy = key;
            appState.sortDirection = key === 'team' ? 'asc' : 'desc'; // Default team sort to A-Z
        }
        sortTable();
    });
    ...
    dom.signupBtn.addEventListener(EVENTS.CLICK, (e) => {
        e.preventDefault(); // Prevent form from submitting on signup click
        handleSignup(e);
    });
