...
function setupEventListeners() {
    ...
    dom.matchDayContainer.addEventListener(EVENTS.CLICK, (e) => {
        ...
        // MODIFIED: Added logic for the new Cancel button
        const cancelButton = e.target.closest('.btn-cancel');
        if (cancelButton) {
            // Find the original scores from the display elements
            ...
            // Reset the input values to what they were before editing
