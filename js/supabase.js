...
export async function switchLeague(league) {
    ...
    try {
        ...
        showFeedback(`Could not load data for ${league}. Please try again later.`, false);
        dom.leagueTableBody.innerHTML = `<tr><td colspan="9" class="empty-state">Failed to load league table.</td></tr>`;
