...
.ucl-theme {
  ...
  --tertiary-bg: #2e2e3a;
  --text-color: #e5e5ff;
  --text-color-secondary: #a0a3d9;
  --accent-color: #fbfbfb;
  --accent-color-hover: #fff500;
  --border-color: #000000;
  --shadow-color: rgba(255, 218, 0, 0.2);
}
...
.ecl-theme {
  ...
  --tertiary-bg: #142c20;
  --text-color: #e0f0e8;
  --text-color-secondary: #a0b0a8;
  --accent-color: #00ff85;
  --accent-color-hover: #50ffaa;
  --border-color: #1e4231;
  --shadow-color: rgba(0, 255, 133, 0.2);
}
...
#global-feedback .feedback-message.show {
    opacity: 1;
    transform: translateY(0);
}
#global-feedback .feedback-message.success { background-color: var(--win-color); }
#global-feedback .feedback-message.error { background-color: var(--loss-color); }
...
@keyframes highlight-fade {
  from { background-color: var(--shadow-color); }
...
/* ADDED: Destructive style for the delete button */
.btn-delete {
  background-color: var(--loss-color);
...
.match-card.is-editing .btn-edit,
.match-card.is-editing .btn-delete {
  display: none;
}

.match-card.is-editing .btn-save,
.match-card.is-editing .btn-cancel {
  display: inline-flex;
  align-items: center;
  justify-content: center;
}

.match-card.is-editing .match-result {
  display: none;
}

.match-card.is-editing .match-score-form {
  display: flex;
}
...
.match-team.home-team .team-logo {
    margin-right: 0.75rem;
}

.match-team.away-team .team-logo {
    margin-left: 0.75rem;
}
...
.match-card:not(.is-editing) .match-result {
    display: flex;
}
...
.match-score-form input[type="number"]::-webkit-outer-spin-button,
.match-score-form input[type="number"]::-webkit-inner-spin-button {
...
.match-score-form button:disabled {
...
.match-card.skeleton .match-team,
.match-card.skeleton .match-result {
  animation: pulse 1.5s infinite ease-in-out;
}

.match-card.skeleton .team-logo-placeholder {
  width: 35px;
  height: 35px;
  border-radius: 50%;
  background-color: var(--tertiary-bg);
...
.match-card.skeleton .text-placeholder {
  height: 20px;
  width: 120px;
  border-radius: 6px;
  background-color: var(--tertiary-bg);
...
@media (max-width: 768px) {
  ...
  .match-card {  font-size: 0.9em; flex-wrap: wrap; }
  .match-result {  font-size: 1.5em;}
    .search-container-wrapper, .match-day, #knockout-content-container {
    width: 100%;
    max-width: 100%;
    border-radius: 0;
    box-sizing: border-box;
